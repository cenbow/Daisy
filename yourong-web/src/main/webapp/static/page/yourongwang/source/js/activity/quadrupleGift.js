 ...
 */
(function () {
    var domian='https://www.yrw.com';
    //https://www.yrw.com
    //http://localhost:8081
    var url = {
        projects: domian+'/activity/leadingSheep/projects',
        gainList: domian+'/activity/leadingSheep/gainList',
        rankList: domian+'/activity/leadingSheep/rankList'
    };
    //请求风云榜
    ...
    //模板渲染
    $.getJSON('../source/data/quadrupleGift.json', function (data) {

        renderProjectsList(data[2]);
    });
