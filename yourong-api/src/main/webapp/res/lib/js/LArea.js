window.LArea = (function () {
    ...
    MobileArea.prototype = {
        init: function (params) {
            ...
            if (params.county) {
                this.county = document.querySelector(params.county);
            }
        ...
        finish: function (e) {
            ...
            if (this.province) {
                this.province.value = provinceText;

            }
            if (this.city) {
                this.city.value = cityText;

            }
            if (this.county) {
                this.county.value = countyText;
