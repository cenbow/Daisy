...
export default {
    ...
    method: {
        ...
        validTips: function (type, message) {
            var style = "error";
            if (type === "success") {
                style = "success";
                message = "";
        ...
        checkMobile: function (config) {
            ...
            if (val.length === 11) {
                ...
                if (isNaN(val)) {
                    _this.next(".m-val-tips").validTips("error", _this.tips.cpnNotCorrect);
                    _this.data({
                        "isCorrect": false
                    });
                    return false;
        ...
        //请求手机验证
        getVerification: function (type, cpn) {
            var isCheckMobile = 2;
        ...
        //限制手机验证码请求
        limitCodeRequest: function () {
            $(".m-input-vercode").html("<div class='u-tips-waring f-round f-w430'>" +
                this.tips.requestLimitError + "</div>");
        },
        //已发送计时
        timerTips: function (type) {
                    ...
                    $.getAPI({
                        ...
                        callback: function (data) {
                            ...
                            if (status === 1) {
                                ...
                                //图形码验证失败
                                _this.parents(".m-input-vercode").find(".m-val-tips").validTips("error", this.tips.imgCodeError);
                            }
                        }
                    });
                }
        ...
        //是否语音选择
        vercodeWrapChoice:function () {
            this.chooseVoice();
            $(".j-phonecode").empty();
        },
        vercodeWrap:function(){
